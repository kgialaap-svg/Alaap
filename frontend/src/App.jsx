...
export default function App() {
  ...
  const fetchLiveHistory = async () => {
    try {
      ...
      if (data.success && Array.isArray(data.data) && data.data.length > 0) {
        ...
        localStorage.setItem('allap_milestones_v7', JSON.stringify(combined));
      }
    } catch (err) {
  ...
  useEffect(() => {
    ...
    const savedMilestones = localStorage.getItem('allap_milestones_v7') || localStorage.getItem('allap_milestones_v6') || localStorage.getItem('allap_milestones_v5');
